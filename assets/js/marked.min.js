...
!(function (e, t) {
    ...
    var b = (function () {
        ...
        return (
              ...
              for (var E, m = f.items.length, x = 0; x < m; x++)
                (this.lexer.state.top = !1),
                  ...
                  f.loose ||
                    ((E =
                      0 <
                        (E = f.items[x].tokens.filter(function (e) {
                          return "space" === e.type;
                        })).length &&
                      E.some(function (e) {
                        return /\n.*\n/.test(e.raw);
          ...
          (t.emStrong = function (e, t, u) {
            ...
            if (
              ...
              if (!r || "" === u || this.rules.inline.punctuation.exec(u)) {
                ...
                for (
                  o.lastIndex = 0, t = t.slice(-1 * e.length + i);
                  null != (n = o.exec(t));
                  ...
                  if (D)
                    if (((l = D.length), n[3] || n[4])) s += l;
                    else if ((n[5] || n[6]) && i % 3 && !((i + l) % 3)) a += l;
                    else if (!(0 < (s -= l)))
                      return (
                        (l = Math.min(l, l + s + a)),
                        (D = e.slice(
                          0,
                          i + n.index + (n[0].length - D.length) + l
                        )),
                        Math.min(i, l) % 2
                          ? ((l = D.slice(1, -1)),
                            {
          ...
          (t.url = function (e, t) {
            ...
            if ((u = this.rules.inline.url.exec(e))) {
              if ("@" === u[2])
                r = "mailto:" + (n = A(this.options.mangle ? t(u[0]) : u[0]));
              else {
                for (
                  ;
                  (i = u[0]),
      ...
      w =
        ...
        (B.gfm.table = h(B.gfm.table)
          ...
          .replace("tag", B._tag)
          .getRegex()),
        (B.gfm.paragraph = h(B._paragraph)
          .replace("hr", B.hr)
          .replace("heading", " {0,3}#{1,6} ")
          .replace("|lheading", "")
        ...
        (B.pedantic = d({}, B.normal, {
          ...
          fences: F,
          lheading: /^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,
          paragraph: h(B.normal._paragraph)
            .replace("hr", B.hr)
            .replace("heading", " *#{1,6} *[^\n]")
    ...
    (w._punctuation = "!\"#$%&'()+\\-.,/:;<=>?@\\[\\]`^{|}~"),
      (w.punctuation = h(w.punctuation)
        .replace(/punctuation/g, w._punctuation)
        .getRegex()),
      (w.blockSkip = /\[[^\]]*?\]\([^\)]*?\)|`[^`]*?`|<[^>]*?>/g),
      (w.escapedEmSt = /(?:^|[^\\])(?:\\\\)*\\[*_]/g),
      (w._comment = h(B._comment).replace("(?:--\x3e|$)", "--\x3e").getRegex()),
      (w.emStrong.lDelim = h(w.emStrong.lDelim)
        .replace(/punct/g, w._punctuation)
        .getRegex()),
      (w.emStrong.rDelimAst = h(w.emStrong.rDelimAst, "g")
        .replace(/punct/g, w._punctuation)
        .getRegex()),
      (w.emStrong.rDelimUnd = h(w.emStrong.rDelimUnd, "g")
        .replace(/punct/g, w._punctuation)
        .getRegex()),
      (w._escapes = /\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/g),
    ...
    var y = (function () {
        ...
        return (
          ...
          (n.inlineTokens = function (r, i) {
            ...
            for (
              ;
              null != (e = this.tokenizer.rules.inline.escapedEmSt.exec(p));
  
            )
              (p =
                p.slice(0, e.index + e[0].length - 2) +
                "++" +
        ...
        return (
          ...
          (t.image = function (e, t, u) {
            return null ===
              (e = f(this.options.sanitize, this.options.baseUrl, e))
              ? u
              : ((e = '<img class="marked-img" src="' + e + '" alt="' + u + '"'),
                t && (e += ' title="' + t + '"'),
                ...
                switch (l.type) {
                  ...
                  case "heading":
                    A += this.renderer.heading(
                      ...
                      l.depth,
                      m(this.parseInline(l.tokens, this.textRenderer)),
                      this.slugger
                    );
                    continue;
                  case "code":
        ...
        if (
          ...
          var c,
            p = function (t) {
              ...
              if (!t)
                try {
                  u.walkTokens && I.walkTokens(l, u.walkTokens),
                    (e = F(l, u)),
            ...
            s.extensions &&
              (s.extensions.forEach(function (r) {
                ...
                if (
                  ...
                  D[r.level]
                    ? D[r.level].unshift(r.tokenizer)
                    : (D[r.level] = [r.tokenizer]),
                    r.start &&
                      ("block" === r.level
                        ? D.startBlock
                ...
                T.passThroughHooks.has(r)
                  ? (l[r] = function (e) {
                      return I.defaults.async
                        ? Promise.resolve(s.hooks[r].call(l, e)).then(function (
                            e
                          ) {
                            return i.call(l, e);
                          })
